 ...
 */
<<<<<<<< HEAD:migrations/Version20250201003107.php
final class Version20250201003107 extends AbstractMigration
========
final class Version20250128114553 extends AbstractMigration
>>>>>>>> 2a8a863 (ediyion added):migrations/Version20250128114553.php
{
...
>>>>>>>> 2a8a863 (ediyion added):migrations/Version20250128114553.php
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, reserved_by_id INT NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, time_slot VARCHAR(255) NOT NULL, INDEX IDX_42C8495589329D25 (resource_id), INDEX IDX_42C84955BCDB4AF4 (reserved_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shared_resource (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, brand_model VARCHAR(255) DEFAULT NULL, commissioning_date DATE DEFAULT NULL, created_at DATETIME DEFAULT NULL, is_archived TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subject_study (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, video_presantation VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495589329D25 FOREIGN KEY (resource_id) REFERENCES shared_resource (id)');
